...
public class RegisterPage extends AppCompatActivity {
            ...
            mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener( new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()){
                        ...
                        Toast.makeText(RegisterPage.this, "Registrasi Berhasil", Toast.LENGTH_SHORT).show();

                        mAuth.signOut();
                        //kembali ke login page
                        Intent lp = new Intent(RegisterPage.this, LoginPage.class);
                        startActivity(lp);
                        progressBar.setVisibility(View.GONE);
                        finish();
                    }else {
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(RegisterPage.this, "Registrasi Gagal", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onBackPressed(){
        ...
        Intent back = new Intent(RegisterPage.this, LoginPage.class);
        startActivity(back);
        finish();
    }
}
