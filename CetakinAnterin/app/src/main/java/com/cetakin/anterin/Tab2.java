...
public class Tab2 extends Fragment {
    ...
    private FirebaseRecyclerAdapter<Order, Tab2.EntryViewHolder> firebaseRecyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView)rootView.findViewById(R.id.kerjakanRecyclerView);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Order> options = new FirebaseRecyclerOptions.Builder<Order>()
                .setQuery(mQuery.equalTo("sedang dikerjakan"), Order.class)
                .build();
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Order, EntryViewHolder>(options) {
            ...
            public EntryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.orderan_dikerjakan_card, parent, false);
    ...
    public class EntryViewHolder extends RecyclerView.ViewHolder {
        ...
        public EntryViewHolder(View itemView) {
            ...
            Button selesai = (Button)mView.findViewById(R.id.btnSelesai);
            selesai.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mOrder.orderByChild("fileUrl").equalTo(fileUrl).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            for (DataSnapshot data:dataSnapshot.getChildren()){
                                data.getRef().child("status").setValue("selesai");
                            }
                        }
            ...
            TextView down_file = (TextView)mView.findViewById(R.id.Kdownload_file);
        ...
        public void setTanggal (String tanggal){
            e_tanggal = (TextView)mView.findViewById(R.id.kerjakan_tanggal);
            e_tanggal.setText(tanggal);
        }

        public void setFile (String file){
            e_file = (TextView)mView.findViewById(R.id.kerjakan_file);
            e_file.setText(file);
        }

        public void setNoHp (String noHp){
            e_nohp = (TextView)mView.findViewById(R.id.kerjakan_nohp);
            e_nohp.setText(noHp);
        }

        public void setAlamat (String alamat){
            e_alamat = (TextView)mView.findViewById(R.id.kerjakan_alamat);
            e_alamat.setText(alamat);
        }

        public void setKeterangan (String keterangan){
            e_keterangan = (TextView)mView.findViewById(R.id.kerjakan_keterangan);
            e_keterangan.setText(keterangan);
        }

        public void setNamaUser (String namaUser){
            e_namauser = (TextView)mView.findViewById(R.id.kerjakan_nama_user);
