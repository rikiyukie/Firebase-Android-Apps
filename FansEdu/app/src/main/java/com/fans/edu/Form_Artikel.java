...
public class Form_Artikel extends AppCompatActivity {
    ...
    private void UploadToDatabase() {
        ...
        Artikel artikel = new Artikel(judul,isi,gambarUrl);
        Date currentTime = Calendar.getInstance().getTime();
        String post_time = currentTime.toString();

        //upload firebase
        mDatabase.child("ARTIKEL").child(post_time).setValue(artikel).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
